...
// 相位顯示順序。不能用 Object.keys(PH):JS 會把「像整數」的鍵(2,3,5…)重排到字母鍵(1A,1B,4A)前面,
// 得到 2,3,5,6,7,8,9,1A,1B,4A —— 順序是錯的。這裡明列正確的開案→募資後續順序。
export const PHASE_ORDER = ["1A", "1B", "2", "3", "4A", "5", "6", "7", "8", "9"];
